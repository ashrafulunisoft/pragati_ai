    ...
    <div class="text-center mb-5">
        <div class="glass-card d-inline-block px-5 py-4 mb-4">
            <h1 class="fw-bold text-white mb-2">
                <i class="fas fa-shield-alt me-2" style="color: var(--accent-emerald);"></i>
                Insurance Packages
            </h1>
    ...
    @if($packages->isEmpty())
        <div class="glass-card p-5 text-center mx-auto" style="max-width: 500px;">
            <div class="text-muted mb-4">
                <i class="fas fa-box-open fa-5x" style="color: var(--accent-emerald);"></i>
            </div>
            <h3 class="fw-bold text-white mb-3">No Packages Available</h3>
                    ...
                    <div class="glass-card h-100 package-card">
                        <div class="card-body p-4">
                            ...
                            <div class="text-center mb-4">
                                ...
                                <h4 class="card-title fw-bold text-white">{{ $package->name }}</h4>
                                <p class="text-muted small mb-0">{{ Str::limit($package->description, 60) }}</p>
                            </div>

                            <!-- Price -->
                            <div class="text-center mb-4">
                                <span class="display-5 fw-bold" style="color: var(--accent-emerald);">${{ number_format($package->price, 2) }}</span>
                            ...
                            <ul class="list-unstyled mb-4">
                                <li class="mb-2 text-white">
                                    <i class="fas fa-check-circle me-2" style="color: var(--accent-emerald);"></i>
