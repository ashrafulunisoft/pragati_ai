...
<body>
  ...
  <div class="container py-5">
    ...
    <!-- Main Content Grid with align-items-start to fix jumping layout -->
    ...
    async function handleUserSubmit(text) {
      ...
      try {
        ...
        const response = await ai.models.generateContent({
          ...
          contents: text,
          config: {
            systemInstruction: "You are a professional assistant for Pragati Life Insurance PLC. Provide clear, accurate info on premiums, policies, and claims in English. Keep answers concise yet helpful. If asked for FAQs, provide common insurance questions and answers.",
            temperature: 0.7
          }
        });
