...
@section('title', 'Rejected Visits - Admin')
...
<div class="glass-card glass-card-dark">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2.5rem; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 1.5rem;">
        ...
        <h2 class="fw-800 mb-0 text-white letter-spacing-1 text-shadow-white" style="font-size: 2rem;">Rejected Visits</h2>
    </div>
        ...
        <div class="col-md-4">
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-white mb-2" style="font-size: 0.85rem; opacity: 0.7;">Total Rejected</h6>
        ...
        <table class="table-custom">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size: 0.85rem; max-width: 200px; color: #ef4444;">{{ $visit->rejected_reason ?? 'No reason provided' }}</td>
                    <td style="font-size: 0.85rem;">{{ $visit->updated_at->diffForHumans() }}</td>
                    <td>
                ...
                <tr>
                    <td colspan="10" class="text-center py-5">
                        <i class="fas fa-times-circle" style="font-size: 48px; opacity: 0.3; margin-bottom: 1rem;"></i>
                        <div class="text-white" style="opacity: 0.5;">No rejected visits found</div>
                    </td>
                </tr>
                @endforelse
            </tbody>
