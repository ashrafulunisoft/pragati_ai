...
@section('title', 'Check-In/Check-Out - Admin')
...
<div class="glass-card glass-card-dark">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2.5rem; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 1.5rem;">
        ...
        <h2 class="fw-800 mb-0 text-white letter-spacing-1 text-shadow-white" style="font-size: 2rem;">Check-In / Check-Out</h2>
    </div>
    ...
    <div class="row g-4 mb-5">
        <div class="col-md-3">
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-white mb-2" style="font-size: 0.85rem; opacity: 0.7;">Pending Check-In</h6>
                        <h3 class="text-white fw-800 mb-0">{{ $visits->where('status', 'approved')->count() }}</h3>
                    </div>
        ...
        <div class="col-md-3">
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-white mb-2" style="font-size: 0.85rem; opacity: 0.7;">Currently In</h6>
                        <h3 class="text-white fw-800 mb-0">{{ $visits->where('status', 'checked_in')->count() }}</h3>
                    </div>
            ...
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="stat-icon" style="background: rgba(168, 85, 247, 0.2);">
                        <i class="fas fa-calendar-day" style="color: #a855f7;"></i>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="stat-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-white mb-2" style="font-size: 0.85rem; opacity: 0.7;">Total Ready</h6>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @elseif($visit->status === 'checked_in')
                            <span class="badge badge-checkedin">
                                <i class="fas fa-user-check me-1"></i> In
                            </span>
                        @else
                    ...
                    <td style="font-size: 0.85rem;">
                        @if($visit->status === 'approved')
                            <i class="fas fa-calendar me-2" style="opacity: 0.6;"></i>
                ...
                <tr>
                    <td colspan="10" class="text-center py-5">
                        <i class="fas fa-exchange-alt" style="font-size: 48px; opacity: 0.3; margin-bottom: 1rem;"></i>
                        <div class="text-white" style="opacity: 0.5;">No visits ready for check-in/check-out</div>
                    </td>
                </tr>
                @endforelse
            </tbody>
