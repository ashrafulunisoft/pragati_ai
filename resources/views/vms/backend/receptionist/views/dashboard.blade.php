...
@section('title', 'Receptionist Dashboard - UCB Bank')

@section('content')
    <!-- Header -->
    <div class="header-section">
        <div>
            <h3 class="fw-800 mb-1 text-white letter-spacing-1">Receptionist Dashboard</h3>
        ...
        <div class="header-profile-box glass-card">
            ...
            <div>
                ...
                <span class="sub-label fs-9">Receptionist</span>
            </div>
        </div>
    </div>
