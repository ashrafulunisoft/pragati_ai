...
<head>
    ...
    <title>Visit Status Update</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                This is to inform you that the status of your visit to <strong>UCB Bank</strong> has been updated.
            </p>

            <div class="status-message">
                <h3 style="margin: 0; color: #667eea;">Your visit is now:</h3>
            ...
            @if($data['status'] === 'approved')
                <div style="background-color: #d4edda; border: 1px solid #c3e6cb; padding: 15px; border-radius: 4px; margin: 20px 0;">
                    ...
                    <p style="margin: 0;">Your visit has been approved. Please arrive 10-15 minutes before your scheduled time and bring a valid photo ID for verification.</p>
                </div>
            @elseif($data['status'] === 'completed')
                <div style="background-color: #cce5ff; border: 1px solid #b8daff; padding: 15px; border-radius: 4px; margin: 20px 0;">
                    <h4 style="margin: 0 0 10px 0; color: #004085;">✅ Visit Completed</h4>
                    <p style="margin: 0;">Thank you for visiting UCB Bank. We appreciate your time and look forward to serving you again.</p>
                </div>
            @elseif($data['status'] === 'cancelled')
                <div style="background-color: #f8d7da; border: 1px solid #f5c6cb; padding: 15px; border-radius: 4px; margin: 20px 0;">
                    ...
                    <p style="margin: 0;">Your visit has been cancelled. If you have any questions or would like to reschedule, please contact us.</p>
                </div>
            @elseif($data['status'] === 'pending')
                <div style="background-color: #fff3cd; border: 1px solid #ffeeba; padding: 15px; border-radius: 4px; margin: 20px 0;">
                    <h4 style="margin: 0 0 10px 0; color: #856404;">⏳ Pending Review</h4>
                    <p style="margin: 0;">Your visit request is pending review. You will be notified once a decision has been made.</p>
                </div>
            @endif
            ...
            <p>
                If you have any questions about this status update, please contact our visitor management team.
            </p>
        </div>
